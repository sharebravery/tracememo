...
export default config(
  ...
  {
    // This config file uses typescript-eslint's `config` helper, which is
    // flagged as deprecated by import-x/no-deprecated. Modernizing it is out
    // of scope; silence the rule for the config file itself.
