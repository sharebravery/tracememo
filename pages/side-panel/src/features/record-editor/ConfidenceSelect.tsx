...
export const ConfidenceSelect = ({ value, onChange, disabled }: ConfidenceSelectProps) => {
  ...
  return (
    <div className="flex flex-col gap-1">
      <label htmlFor="tracememo-confidence" className="text-[11px] font-medium uppercase tracking-wide text-slate-500">
        Your confidence
      </label>
      <select
        ...
        disabled={disabled}
        className="w-full rounded-lg border border-white/10 bg-white/5 px-2 py-1.5 text-sm text-slate-100 focus:border-violet-500/60 focus:outline-none focus:ring-1 focus:ring-violet-500/40 disabled:opacity-50">
